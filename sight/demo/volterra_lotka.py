...
_GAMMA = flags.DEFINE_float(
    'gamma', 0.4, 'Rate of death of predator population.'
)
_DELTA = flags.DEFINE_float(
    'delta', 0.1, 'Rate of growth of predator population.'
)
...
#   logging.info('steps=%s', steps)
  ...
  if math.isinf(r):
    ...
    decision.decision_outcome('prey_pop', r if r < 100 else 100-3*(r-100), sight)
...
''',
        state_attrs={
            ...
            'F': sight_pb2.DecisionConfigurationStart.AttrProps(
                min_value=0, max_value=100,
                description='The number of predator animals in the population'
            ),
        },
        action_attrs={
            'R0': sight_pb2.DecisionConfigurationStart.AttrProps(
                min_value=0, max_value=20,
                description='The number of predator animals in the population at the start of the simulation.'
            ),
            'F0': sight_pb2.DecisionConfigurationStart.AttrProps(
                min_value=0, max_value=20,
                description='The number of prey animals in the population at the start of the simulation.'
            ),
