...
_ACME_RESPONSE_LAYER_WEIGHTSDATA = _ACME_RESPONSE_LAYER.nested_types_by_name[
    'WeightsData']
_DECISIONPOINTREQUEST = DESCRIPTOR.message_types_by_name['DecisionPointRequest']
_DECISIONPOINTRESPONSE = DESCRIPTOR.message_types_by_name[
    'DecisionPointResponse']
_FETCHOPTIMALACTIONREQUEST = DESCRIPTOR.message_types_by_name[
    'FetchOptimalActionRequest']
_FETCHOPTIMALACTIONRESPONSE = DESCRIPTOR.message_types_by_name[
...
_CURRENTSTATUSRESPONSE = DESCRIPTOR.message_types_by_name[
...
_PROPOSEACTIONRESPONSE = DESCRIPTOR.message_types_by_name[
...
_GETOUTCOMERESPONSE_OUTCOME = _GETOUTCOMERESPONSE.nested_types_by_name[
    'Outcome']
_FINALIZEEPISODEREQUEST = DESCRIPTOR.message_types_by_name[
    'FinalizeEpisodeRequest']
_FINALIZEEPISODERESPONSE = DESCRIPTOR.message_types_by_name[
    'FinalizeEpisodeResponse']
...
_DECISIONPOINTRESPONSE_ACTIONTYPE = _DECISIONPOINTRESPONSE.enum_types_by_name[
    'ActionType']
_CURRENTSTATUSRESPONSE_STATUS = _CURRENTSTATUSRESPONSE.enum_types_by_name[
    'Status']
_GETOUTCOMERESPONSE_OUTCOME_STATUS = _GETOUTCOMERESPONSE_OUTCOME.enum_types_by_name[
    'Status']
_WORKERALIVERESPONSE_STATUSTYPE = _WORKERALIVERESPONSE.enum_types_by_name[
    'StatusType']
Acme_Request = _reflection.GeneratedProtocolMessageType(
    'Acme_Request',
    (_message.Message,),
    {
...
Acme_Response = _reflection.GeneratedProtocolMessageType(
    'Acme_Response',
    (_message.Message,),
    {
        'Layer': _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                'WeightsData': _reflection.GeneratedProtocolMessageType(
                    'WeightsData',
                    (_message.Message,),
                    {
...
DecisionPointRequest = _reflection.GeneratedProtocolMessageType(
...
DecisionPointResponse = _reflection.GeneratedProtocolMessageType(
    'DecisionPointResponse',
    (_message.Message,),
    {
...
FetchOptimalActionRequest = _reflection.GeneratedProtocolMessageType(
    'FetchOptimalActionRequest',
    (_message.Message,),
    {
...
FetchOptimalActionResponse = _reflection.GeneratedProtocolMessageType(
    'FetchOptimalActionResponse',
    (_message.Message,),
    {
...
TellRequest = _reflection.GeneratedProtocolMessageType(
    'TellRequest',
    (_message.Message,),
    {
...
TellResponse = _reflection.GeneratedProtocolMessageType(
    'TellResponse',
    (_message.Message,),
    {
...
CurrentStatusRequest = _reflection.GeneratedProtocolMessageType(
...
CurrentStatusResponse = _reflection.GeneratedProtocolMessageType(
    'CurrentStatusResponse',
    (_message.Message,),
    {
...
LaunchRequest = _reflection.GeneratedProtocolMessageType(
    'LaunchRequest',
    (_message.Message,),
    {
...
LaunchResponse = _reflection.GeneratedProtocolMessageType(
    'LaunchResponse',
    (_message.Message,),
    {
...
ProposeActionRequest = _reflection.GeneratedProtocolMessageType(
...
ProposeActionResponse = _reflection.GeneratedProtocolMessageType(
    'ProposeActionResponse',
    (_message.Message,),
    {
...
GetOutcomeRequest = _reflection.GeneratedProtocolMessageType(
    'GetOutcomeRequest',
    (_message.Message,),
    {
...
GetOutcomeResponse = _reflection.GeneratedProtocolMessageType(
    'GetOutcomeResponse',
    (_message.Message,),
    {
...
FinalizeEpisodeRequest = _reflection.GeneratedProtocolMessageType(
    'FinalizeEpisodeRequest',
    (_message.Message,),
    {
...
FinalizeEpisodeResponse = _reflection.GeneratedProtocolMessageType(
    'FinalizeEpisodeResponse',
    (_message.Message,),
    {
...
TestRequest = _reflection.GeneratedProtocolMessageType(
    'TestRequest',
    (_message.Message,),
    {
...
TestResponse = _reflection.GeneratedProtocolMessageType(
    'TestResponse',
    (_message.Message,),
    {
...
WorkerAliveRequest = _reflection.GeneratedProtocolMessageType(
    'WorkerAliveRequest',
    (_message.Message,),
    {
...
WorkerAliveResponse = _reflection.GeneratedProtocolMessageType(
    'WorkerAliveResponse',
    (_message.Message,),
    {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SIGHTSERVICE.methods_by_name[
      'Test']._serialized_options = b'\202\323\344\223\002\026\022\024/v1/test/{client_id}'
  _SIGHTSERVICE.methods_by_name['Create']._options = None
  _SIGHTSERVICE.methods_by_name[
      'Create']._serialized_options = b'\202\323\344\223\002\014\022\n/v1/create'
  _SIGHTSERVICE.methods_by_name['Close']._options = None
  _SIGHTSERVICE.methods_by_name[
      'Close']._serialized_options = b'\202\323\344\223\002\013\022\t/v1/Close'
  _SIGHTSERVICE.methods_by_name['WorkerAlive']._options = None
  _SIGHTSERVICE.methods_by_name[
      'WorkerAlive']._serialized_options = b'\202\323\344\223\002\021\022\017/v1/WorkerAlive'
  _SIGHTSERVICE.methods_by_name['Launch']._options = None
  _SIGHTSERVICE.methods_by_name[
      'Launch']._serialized_options = b'\202\323\344\223\0028\"\036/v1/launch/{client_id}/{label}:\026decision_config_params'
  _SIGHTSERVICE.methods_by_name['DecisionPoint']._options = None
  _SIGHTSERVICE.methods_by_name[
      'DecisionPoint']._serialized_options = b'\202\323\344\223\0029\"*/v1/decision_point/{client_id}/{worker_id}:\013acme_config'
  _SIGHTSERVICE.methods_by_name['Tell']._options = None
  _SIGHTSERVICE.methods_by_name[
      'Tell']._serialized_options = b'\202\323\344\223\002\"\" /v1/tell/{client_id}/{worker_id}'
  _SIGHTSERVICE.methods_by_name['Listen']._options = None
  _SIGHTSERVICE.methods_by_name[
      'Listen']._serialized_options = b'\202\323\344\223\002$\022\"/v1/listen/{client_id}/{worker_id}'
  _SIGHTSERVICE.methods_by_name['CurrentStatus']._options = None
  _SIGHTSERVICE.methods_by_name[
      'CurrentStatus']._serialized_options = b'\202\323\344\223\002,\022*/v1/current_status/{client_id}/{worker_id}'
  _SIGHTSERVICE.methods_by_name['FetchOptimalAction']._options = None
  _SIGHTSERVICE.methods_by_name[
      'FetchOptimalAction']._serialized_options = b'\202\323\344\223\0022\0220/v1/fetch_optimal_action/{client_id}/{worker_id}'
  _SIGHTSERVICE.methods_by_name['FinalizeEpisode']._options = None
  _SIGHTSERVICE.methods_by_name[
      'FinalizeEpisode']._serialized_options = b'\202\323\344\223\002;\",/v1/finalize_episode/{client_id}/{worker_id}:\013acme_config'
  _LOGFORMAT._serialized_start = 3781
  _LOGFORMAT._serialized_end = 3872
  ...
  _LAUNCHREQUEST._serialized_start = 1913
  _LAUNCHREQUEST._serialized_end = 2037
  _LAUNCHRESPONSE._serialized_start = 2039
  _LAUNCHRESPONSE._serialized_end = 2079
  _PROPOSEACTIONREQUEST._serialized_start = 2082
  _PROPOSEACTIONREQUEST._serialized_end = 2225
  _PROPOSEACTIONRESPONSE._serialized_start = 2227
  _PROPOSEACTIONRESPONSE._serialized_end = 2269
  _GETOUTCOMEREQUEST._serialized_start = 2271
  _GETOUTCOMEREQUEST._serialized_end = 2329
  _GETOUTCOMERESPONSE._serialized_start = 2332
  _GETOUTCOMERESPONSE._serialized_end = 2835
  _GETOUTCOMERESPONSE_OUTCOME._serialized_start = 2417
  _GETOUTCOMERESPONSE_OUTCOME._serialized_end = 2835
  _GETOUTCOMERESPONSE_OUTCOME_STATUS._serialized_start = 2759
  _GETOUTCOMERESPONSE_OUTCOME_STATUS._serialized_end = 2835
  _FINALIZEEPISODEREQUEST._serialized_start = 2838
  _FINALIZEEPISODEREQUEST._serialized_end = 3222
  _FINALIZEEPISODERESPONSE._serialized_start = 3224
  _FINALIZEEPISODERESPONSE._serialized_end = 3292
  _TESTREQUEST._serialized_start = 3294
  _TESTREQUEST._serialized_end = 3326
  _TESTRESPONSE._serialized_start = 3328
  _TESTRESPONSE._serialized_end = 3355
  _CREATEREQUEST._serialized_start = 3357
  _CREATEREQUEST._serialized_end = 3372
  _CREATERESPONSE._serialized_start = 3374
  _CREATERESPONSE._serialized_end = 3423
  _CLOSEREQUEST._serialized_start = 3425
  _CLOSEREQUEST._serialized_end = 3458
  _CLOSERESPONSE._serialized_start = 3460
  _CLOSERESPONSE._serialized_end = 3497
  _WORKERALIVEREQUEST._serialized_start = 3499
  _WORKERALIVEREQUEST._serialized_end = 3557
  _WORKERALIVERESPONSE._serialized_start = 3560
  _WORKERALIVERESPONSE._serialized_end = 3779
  _WORKERALIVERESPONSE_STATUSTYPE._serialized_start = 3712
  _WORKERALIVERESPONSE_STATUSTYPE._serialized_end = 3779
  _SIGHTSERVICE._serialized_start = 3875
  _SIGHTSERVICE._serialized_end = 5497
