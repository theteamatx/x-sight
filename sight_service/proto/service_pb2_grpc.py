...
class SightServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendFunction = channel.unary_unary(
                '/sight.x.service.SightService/SendFunction',
                request_serializer=sight__service_dot_proto_dot_service__pb2.SendFunctionRequest.SerializeToString,
                response_deserializer=sight__service_dot_proto_dot_service__pb2.SendFunctionResponse.FromString,
                )
...
def add_SightServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendFunction': grpc.unary_unary_rpc_method_handler(
                    servicer.SendFunction,
                    request_deserializer=sight__service_dot_proto_dot_service__pb2.SendFunctionRequest.FromString,
                    response_serializer=sight__service_dot_proto_dot_service__pb2.SendFunctionResponse.SerializeToString,
            ),
...
class SightService(object):
    ...
    def SendFunction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sight.x.service.SightService/SendFunction',
            sight__service_dot_proto_dot_service__pb2.SendFunctionRequest.SerializeToString,
            sight__service_dot_proto_dot_service__pb2.SendFunctionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
