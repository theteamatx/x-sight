...
#### Setup yapf formatter in vscode
...
Set up your gcloud CLI configurations using
...
Note : all the following commands using $PROJECT_ID assumes you have it already set to your gcp project id. If not, set it via
```bash
