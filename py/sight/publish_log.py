...
from google3.analysis.dremel.core.capacitor.public.python import (
    pywrap_record_reader  # pylint:disable=line-too-long
)
...
_LOG_FILE = gpath_flag.DEFINE_path('log_file',
                                   None,
                                   'File that contains the Sight log.',
                                   required=True)

_LOG_OWNER = flags.DEFINE_string('log_owner',
                                 None,
                                 'The owner of the published log.',
                                 required=True)
