...
def build_dataset(sim_log: pd.DataFrame, hist_len: int, train_frac:float) -> Dataset:
...
def main(argv: Sequence[str]) -> None:
  ...
  dataset.train_df.to_csv(_OUTPUT_PATH_TRAIN.value, index=False, quoting=csv.QUOTE_ALL)
  dataset.train_data_df.to_csv(_OUTPUT_PATH_TRAIN_DATA.value, index=False, quoting=csv.QUOTE_ALL)
  dataset.validate_df.to_csv(_OUTPUT_PATH_VAL.value, index=False, quoting=csv.QUOTE_ALL)
  dataset.train_data_df.to_csv(_OUTPUT_PATH_VAL_DATA.value, index=False, quoting=csv.QUOTE_ALL)
