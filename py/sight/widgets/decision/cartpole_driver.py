...
from sight.widgets.decision.acme.cartpole import CartPoleEnv
...
def driver_fn(sight) -> None:
  ...
  while not timestep.last():
    ...
    # timestep = CartPoleEnv.step(action_received)
    timestep = cartpole_env.step(chosen_action)
    # print("timestep :", timestep)
    # raise SystemError
