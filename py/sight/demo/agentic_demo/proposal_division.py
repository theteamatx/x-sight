...
@tool
def division_api_with_sight(a: int, b: int) -> str:
  """
  Perform a Division operation on two integers using the Sight backend system.
...
if __name__ == "__main__":
  result = division_api_with_sight.invoke({"a": 10, "b": 2})
  print(result)
