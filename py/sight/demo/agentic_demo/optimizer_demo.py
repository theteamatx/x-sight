  ...
  with Sight.create(params, config) as sight:
    ...
    response = agent.invoke([
        SystemMessage(content="""You are an expert Python programmer.
            ...
            Just output the raw Python function code. Do not include any special characters and not in markdown file format, just plaintext"""),
    ...
    response = service.call(lambda s, meta: s.SendFunction(req, 300, metadata=meta))
