...
@tool
def subtraction_api_with_sight(a: int, b: int) -> str:
  """
  Perform Subtraction operation on two integers using the Sight backend system.
  ...
  Example:
      >>> subtraction_api_with_sight(5, 3)
      "2"
  """
...
if __name__ == "__main__":
  result = subtraction_api_with_sight.invoke({"a": 10, "b": 2})
  print(result)
