...
def main(argv):
  ...
  with get_sight_instance() as sight:
    decision.run(
          driver_fn=driver,
          state_attrs={
                'state_1': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=100,
                ),
                'state_2': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=100,
                ),
                'state_3': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=100,
                )
          },
          action_attrs={
                'action_1': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=10,
                ),
                'action_2': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=10,
                ),
                'action_3': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=10,
                )
          },
          sight=sight,
          outcome_attrs={
                'sum': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=10000,
                    description='The sum of choosen action params.',
                ),
                'avg': sight_pb2.DecisionConfigurationStart.AttrProps(
                    min_value=0, max_value=100,
